    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../imagenes/farmacia1.jpg" class="d-block w-100" alt="Imagen 1">
        </div>
        <div class="carousel-item">
          <img src="../imagenes/farmacia9.png" class="d-block w-100" alt="Imagen 9">
        </div>
        <div class="carousel-item">
          <img src="../imagenes/farmacia10.png" class="d-block w-100" alt="Imagen 10">
        </div>
        <div class="carousel-item">
          <img src="../imagenes/farmacia11.png" class="d-block w-100" alt="Imagen 11">
        </div>
        <div class="carousel-item">
          <img src="../imagenes/farmacia12.png" class="d-block w-100" alt="Imagen 12">
        </div>
      </div>
    ...
    <nav>
      <ul class="pagination">
        <?php for ($i = 1; $i <= $total_productos; $i++): ?>
          <li class="page-item">
            <form action="pagina" method="post" class="d-inline"><button type="submit" class="page-link" name="page"
