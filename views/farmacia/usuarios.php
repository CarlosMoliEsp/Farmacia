      ...
      <tbody>
        <?php foreach ($usuarios as $fila): ?>
          <tr>
            ...
            <td>
              <form action="borrarUsuario" method="post" class="d-inline">
                <button type="submit" class="btn btn-danger btn-sm" name="id_usuario"
                  value="<?= htmlspecialchars($fila["id"]); ?>">Borrar</button>
              </form>
              <form action="mostrarEditarUsuario" method="post" class="d-inline">
                <button type="submit" class="btn btn-warning btn-sm" name="id_usuario"
                  value="<?= htmlspecialchars($fila["id"]); ?>">Editar</button>
              </form>
            </td>
          </tr>
        <?php endforeach; ?>
