...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <?php if ($_SESSION['rolUsuario'] == 'admin'): ?>
          <li class="nav-item">
            <a class="nav-link" href="form_insertarCategoria">Añadir Categoria</a>
          </li>
        <?php endif; ?>
        <li class="nav-item">
  ...
  <div class="container">
    ...
    <form action="editarCategoria" method="post">
      <!-- Verifica si $categoria no es null antes de usar sus propiedades -->
      <input type="hidden" value="<?= $categoria ? $categoria['id'] : '' ?>" name="id">

      <div class="form-group">
        <label for="nombre">Nombre:</label>
        <!-- Verifica si $categoria no es null antes de usar sus propiedades -->
        <input type="text" class="form-control" id="nombre" name="nombre"
          value="<?= $categoria ? $categoria['nombre'] : '' ?>" required>
        <?php if (isset($errores['error_nombre'])): ?>
          <small class="form-text text-danger"><?= $errores['error_nombre'] ?></small>
        <?php endif; ?>
        <?php if (isset($errores['error_general'])): ?>
          <small class="form-text text-danger"><?= $errores['error_general'] ?></small>
        <?php endif; ?>
      </div>
