    ...
    <div class="container mt-5 d-flex flex-column align-items-center">
        <div class="form-container">
            <form action="registrar" method="post">
                <!-- Input oculto para saber que id estas editando -->
                ...
                <div class="form-group">
                    ...
                    <?php if ($errores): ?>
                        <small class="text-danger"><?= $errores['error_nombre'] ?></small>
                    <?php endif; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if ($errores): ?>
                        <small class="text-danger"><?= $errores['error_apellidos'] ?></small>
                    <?php endif; ?>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <button type="submit" class="btn btn-custom" name="login">Registrar</button>
                    <a class="btn btn-custom" href="logout">Salir</a>
                </div>
            </form>
        </div>
    </div>
